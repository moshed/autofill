...
#
# Sparkle checks https://dancykier.com/autofill/appcast.xml once a day. The site
...
FEED="https://dancykier.com/autofill"
...
<rss version="2.0" xmlns:sparkle="http://www.andymatuschak.org/xml-namespaces/sparkle">
  <channel>
    ...
    <description>Autofill updates</description>
    ...
    <item>
      ...
      <enclosure url="$FEED/Autofill-$VER.zip"
                 length="$SIZE"
